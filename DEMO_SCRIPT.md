...
```mermaid
graph TD
    A[Min 0-1: Inicio & Home] --> B[Min 1-2: Catálogo y Filtros]
    B --> C[Min 2-3: Detalle e Interés]
    C --> D[Min 3-5: Recepción & Kanban en InmoDesk]
    D --> E[Min 5-6: Captación y Contacto General]
    E --> F[Min 6-7: Cierre Comercial]
    style A fill:#0d9488,stroke:#0f172a,stroke-width:2px,color:#fff
    style D fill:#b45309,stroke:#0f172a,stroke-width:2px,color:#fff
```
